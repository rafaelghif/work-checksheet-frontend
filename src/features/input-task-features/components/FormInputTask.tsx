    ...
    return (
        <form onSubmit={handleSubmit} className="flex flex-col w-full gap-3 px-3 py-2 mt-3">
            ...
            <div className="flex flex-col w-full gap-1" >
                ...
                <input type="file" accept="image/*, .jpeg, .jpg, .png, image/png, image/gif, image/jpeg" multiple={true} onChange={(e) => handleChangeFiles(e.target.files)} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
            </div>
